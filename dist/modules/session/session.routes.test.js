...
vi.mock('../../db/index.js', () => ({
    db: {
        query: {
            session: { findFirst: (...args) => mockDbSession.findFirst(...args) },
            game: { findFirst: (...args) => mockDbGame.findFirst(...args) },
            playerGame: { findFirst: (...args) => mockDbPlayerGame.findFirst(...args) },
        },
        insert: vi.fn(() => ({
            values: vi.fn(() => ({
...
function makeAuthToken(app, playerId = 'master-1') {
...
//# sourceMappingURL=session.routes.test.js.map