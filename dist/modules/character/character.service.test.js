...
describe('CharacterService.create', () => {
    it('calculates maxHp, maxEffort and bExp on creation', async () => {
        ...
        mockRepo.create.mockImplementation(async (data) => ({ id: 'c1', ...data }));
        const result = await service.create({ gameId: 'g1', nickname: 'Hero', level: 5, constitution: 2, profConstitution: 0, profCognition: 0, profPsyche: 0, profInstinct: 0, profMotricity: 0, profPerception: 0, cognition: 0, psyche: 0, instinct: 0, motricity: 0, perception: 0 }, 'p1');
    ...
    it('throws ForbiddenError when player is not in the game', async () => {
        ...
        await expect(service.create({ gameId: 'g1', nickname: 'Hero', level: 1, constitution: 0, profConstitution: 0, profCognition: 0, profPsyche: 0, profInstinct: 0, profMotricity: 0, profPerception: 0, cognition: 0, psyche: 0, instinct: 0, motricity: 0, perception: 0 }, 'p1')).rejects.toThrow(ForbiddenError);
    });
});
...
//# sourceMappingURL=character.service.test.js.map